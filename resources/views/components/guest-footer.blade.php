    ...
    <div class="container">
        <div class="row">
            <div class="col-lg-6">
                ...
                <ul class="social-list list-inline mt-3">
                    @if (isset($footer_socials['social_facebook']))
        ...
        <div class="row flex-center">
            <div class="col-md-6 order-0">
                <p class="text-200 text-center text-md-start">All rights Reserved ©
            ...
            <div class="col-md-6 order-1">
                <p class="text-muted text-center text-md-end"> Made with&nbsp;
                    ...
                    </svg>&nbsp;by&nbsp;<a class="text-200 fw-bold" href="https://avntech.vn/" target="_blank">AvnTech
                    </a>
                </p>
            </div>
        </div>
