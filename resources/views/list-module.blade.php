        ...
        <div class="row">
            <div class="col-12">
                <div class="page-title-box">
                    <h4 class="page-title">@lang('settings.List') module</h4>
                </div>
            </div>
        </div>
        <!-- end page title -->
                                        ...
                                        <td>
                                            <form action="{{ route('switch-module') }}" method="post">
                                                ...
                                                <button type="submit" class="bg-transparent border-0 p-0">
                                                    <i
                                                        class="mdi {{ $module->isEnabled() == 1 ? 'mdi-toggle-switch text-success' : 'mdi-toggle-switch-off' }} fs-2"></i>
                                                </button>
                                            </form>
                                        </td>
                                    </tr>
