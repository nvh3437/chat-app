...
<html lang="en">
    <head>
        <meta charset="utf-8" />
        <title>Lỗi 403 - Không có quyền truy cập</title>
                ...
                <div class="row justify-content-center">
                    <div class="col-lg-4">
                        <div class="text-center">
                            <img src="{{ asset('resources/assets/images/file-searching.svg') }}" height="90" alt="File not found Image">
                            <h1 class="text-error mt-4">403</h1>
                            <h4 class="text-uppercase text-danger mt-3">Không có quyền truy cập</h4>
                            <p class="text-muted mt-3">Bạn không có quyền truy cập vào trang này, vui lòng quay trở lại.</p>
