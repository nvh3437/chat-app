                ...
                <div class="card cta-box overflow-hidden">
                    <div class="card-body">
                        <div class="d-flex align-items-center">
                            ...
                            <img class="ms-3" src="{{ asset('resources/assets/images/email-campaign.svg') }}" width="92"
            ...
            <div class="col-xl-4 col-lg-6">
                <div class="card">
                    <div class="card-body">
                        ...
                        <div id="sessions-os" class="apex-charts mt-3" data-colors="#727cf5,#0acf97,#fa5c7c,#ffbc00">
                        </div>
