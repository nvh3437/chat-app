...
@section('title')
    @lang('settings.Add.add') @lang('settings.CMS_page')
@endsection
@section('content')
        ...
        <div class="row">
            <div class="col-12">
                <div class="page-title-box">
                    <h4 class="page-title">@lang('settings.Add.add') @lang('settings.CMS_page')</h4>
                </div>
            </div>
        </div>
        <div class="row">
                    ...
                    <div class="card">
                        <div class="card-body">
                            <div class="row">
                                ...
                                <label class="form-label mt-2 name-group d-none">
                                    @lang('settings.Title') <span class="text-danger">*</span>
                                </label>
                                <div class="col-lg-4 name-group d-none">
                                ...
                                <div class="col-lg-12 single-description">
                                    ...
                                    <textarea class="form-control editor" name="description" id="editor" rows="5"></textarea>
                                </div>
