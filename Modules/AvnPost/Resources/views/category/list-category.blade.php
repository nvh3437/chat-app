                        ...
                        <form action="{{ route('store-category') }}" method="POST" enctype="multipart/form-data">
                            ...
                            <div class="input-group mb-3 row">
                                <div class="mb-2 col-12">
                                    <label class="form-label">Icon <span class="text-danger">*</span>
                                        <br>
                                        <small>Được sử dụng cho SEO</small>
                                    </label>
                                                ...
                                                <form action="{{ route('update-category', $item->id) }}" method="POST"
                                                    ...
                                                    <div class="modal-body text-dark">
                                                        ...
                                                        <div class="col-12">
                                                            ...
                                                            <textarea class="form-control" name="keywords" rows="3" required>{!! $item->description !!}</textarea>
                                                        </div>
                                                    </div>
