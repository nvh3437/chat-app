            ...
            <div class="col-xl-4 col-lg-5">
                <div class="card text-center">
                    <div class="card-body">
                        ...
                        @else
                            <img src="{{ asset($user->partern->img) }}" class="rounded-circle avatar-lg img-thumbnail">
                        @endif
                                        ...
                                        <div class="col-md-6">
                                            <div class="mb-2">
                                                ...
                                                <div class="form-check mt-2">
                                                    <input type="checkbox" name="exp_status" value="1" class="form-check-input" {{ $user->partern->exp_status == 1 ? 'checked' : '' }}>
                                            ...
                                            <div class="mb-2">
                                                ...
                                                <select class="form-select" name="gender">
                                                    <option value="0" class="form-control"
                                                        {{ $user->partern && $user->partern->gender == '0' ? 'selected' : '' }}>Nam
                                                    </option>
                                                    <option value="1" class="form-control"
                                                        {{ $user->partern && $user->partern->gender == '1' ? 'selected' : '' }}>Nữ
                                                    </option>
                                                </select>
                                                <div class="form-check mt-2">
                                                    <input type="checkbox" name="gender_status" value="1" class="form-check-input" {{ $user->partern->gender_status == 1 ? 'checked' : '' }}>
                                    ...
                                    <div class="row">
                                        <div class="col-12">
                                            <div class="mb-2">
                                                ...
                                                <textarea class="form-control" name="address" rows="4">{!! $user->partern->address !!}</textarea>
                                                <div class="form-check mt-2">
                                                    <input type="checkbox" name="address_status" value="1" class="form-check-input" {{ $user->partern->address_status == 1 ? 'checked' : '' }}>
