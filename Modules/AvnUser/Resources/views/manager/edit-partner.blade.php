                                ...
                                <div class="col-lg-6">
                                    ...
                                    <select class="form-select" name="gender">
                                        <option value="0" class="form-control"
                                            {{ $partner && $partner->gender == '0' ? 'selected' : '' }}>Nam
                                        </option>
                                        <option value="1" class="form-control"
                                            {{ $partner && $partner->gender == '1' ? 'selected' : '' }}>Nữ
                                        </option>
                                    </select>
                                </div>
                                <div class="col-lg-12">
                ...
                <div class="card">
                    <div class="card-body shadow-lg">
                        ...
                        @if (count($user->sessions))
                                ...
                                <div class="text-center">
                                    <a href="{{ route('list-session-user', ['user_id' => $user->id]) }}" class="btn btn-outline-primary">Xem
                                        thêm</a>
                                </div>
                            @endif
                    </div>
