...
@section('title')
    @lang('settings.Add.add') @lang('settings.Partner')
@endsection
@section('content')
        ...
        <div class="row">
            <div class="col-12">
                <div class="page-title-box">
                    <h4 class="page-title">@lang('settings.Add.add') @lang('settings.Partner')</h4>
                </div>
            </div>
        </div>
        <div class="row">
                    ...
                    <div class="card">
                        <div class="card-body shadow-lg">
                            ...
                            <div class="row">
                                ...
                                <div class="col-lg-6">
                                    <label class="form-label mt-2">
                                        @lang('avnuser::profile.Experience') <span class="text-danger">*</span>
                                    </label>
