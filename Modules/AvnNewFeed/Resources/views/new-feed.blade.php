...
@section('content')
                ...
                <div class="card">
                    <div class="card-body">
                        ...
                        <div class="d-flex align-self-start">
                            ...
                            @else
                                <img class="d-flex align-self-start rounded me-2"
                                    src="{{ asset('/resources/assets/images/logo.png') }}" style="height: 48px; width: 48px; object-fit: cover;">
                            @endif
                        ...
                        <div class="list-group list-group-flush mt-2">
                            ...
                            <a href="{{ route('my-feed') }}" class="list-group-item list-group-item-action {{ (Route::currentRouteName() == 'my-feed') ? 'text-primary' : '' }} border-0"><i
                        ...
                        <div class="tab-content">
                            <div class="tab-pane show active p-3" id="newpost">
                                <div class="border rounded">
                                    <form action="{{ $is_edit ? route('update-feed', $edit_feed->id) : route('store-feed') }}" method="POST" enctype="multipart/form-data"
                                            ...
                                            <div>
                                                <div class="form-check">
                                                    <input type="checkbox" class="form-check-input" name="status"
                                                        value="1" {{ ($is_edit && $edit_feed->status == 1) ? 'checked' : '' }}>
                            ...
                            <div class="card-body pb-1">
                                ...
                                <div class="my-1">
                                    <a href="javascript: void(0);"
                                        feed-id="{{$item->id}}"
                                        class="like-btn btn btn-sm btn-link text-muted ps-0"><i class='mdi mdi-thumb-up{{NewFeedLikeController::isLikeFeed($item->id)?'':'-outline'}}'></i>
                                    ...
                                    <div class="modal-dialog modal-dialog-centered">
                                        <div class="modal-content">
                                            <div class="modal-header">
                                                <h5 class="modal-title text-dark">Bài viết của {{$item->new_feed_user->name}}</h5>
                                            ...
                                            <div class="modal-body">
                                                ...
                                                <div class="comments" post-id="{{ $item->id }}" total="{{$item->new_feed_comments->count()}}">
                                                ...
                                                <div>
                                                    <hr />
                                                    <a href="javascript: void(0);" class="loadmore-cm btn btn-sm btn-link text-muted ps-0" comment-count="{{$comment_count}}" feed-id="{{$item->id}}">Xem thêm bình luận</a>
                                                </div>
                                                @endif
                                            </div>
    ...
    <div class="modal fade" style="background-color: rgba(49,58,70,0.7);" id="edit-comment"
        ...
        <div class="modal-dialog modal-dialog-centered">
            <div class="modal-content">
                ...
                <form action="{{ route('update-comment-feed', 0) }}"
                    method="POST">
                    @csrf
                    @method('PUT')
        ...
        <div class="modal-dialog modal-dialog-centered">
            <div class="modal-content">
                ...
                <div class="modal-footer">
                    ...
                    <form
                        action="{{ route('delete-comment-feed', 0) }}"
                        method="POST">
                        @csrf
                        @method('delete')
                        <button type="submit"
