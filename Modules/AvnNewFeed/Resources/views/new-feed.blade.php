                ...
                <div class="card">
                    <div class="card-body">
                        ...
                        <div class="list-group list-group-flush mt-2">
                            ...
                            <a href="{{ route('my-feed') }}" class="list-group-item list-group-item-action border-0"><i
                        ...
                        <div class="card-body pb-1">
                            <div class="d-flex">
                                ...
                                <div class="w-100">
                                    ...
                                    <p class="text-muted">
                                        <small>{{ NotificationController::timeAgo($item->updated_at) }}</small>
                                    </p>
                                </div>
                            </div>
                            <hr class="m-0" />
                                ...
                                @foreach ($item->new_feed_comments as $child)
                                    <div class="d-flex">
                                        ...
                                        <div>
                                            ...
                                            <div class="modal fade" id="delete-child-{{ $child->id }}" tabindex="-1"
                                                aria-hidden="true">
                                                <div class="modal-dialog">
                                                    <div class="modal-content">
                                                        <div class="modal-header">
